...
contract Messenger is CCIPReceiver, OwnerIsCreator {
    ...
    event MessageReceived(
        ...
        bytes sender, // The address of the sender from the source chain.
    ...
    bytes public s_sender; // store the aptos sender address
        ...
        override
    {
        ...
        s_sender = any2EvmMessage.sender;

        emit MessageReceived(
            any2EvmMessage.messageId,
            any2EvmMessage.sourceChainSelector, // fetch the source chain identifier (aka selector)
            any2EvmMessage.sender, // abi-decoding of the sender address,
