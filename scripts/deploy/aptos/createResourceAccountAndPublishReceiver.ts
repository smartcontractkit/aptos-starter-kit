import { Aptos, AptosConfig, Network, Account, Ed25519PrivateKey, AuthenticationKey, DeriveScheme } from "@aptos-labs/ts-sdk";
...
async function createResourceAccountAndPublish() {
  console.log("--- Starting Resource Account Creation & Package Publish Process ---");
  ...
  try {
    ...
    console.log(`Derived Resource Account Address: ${resourceAccountAddress.toString()}`);
    ...
    console.log(`Resource Account Address: ${resourceAccountAddress.toString()}`);
