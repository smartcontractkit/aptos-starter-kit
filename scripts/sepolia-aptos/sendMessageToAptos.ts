...
async function transferTokenPayLink() {
    ...
    try {
        ...
        const ccipMessage = buildCCIPMessage(
            recipient,
            "0x48656c6c6f206170746f73", // test data, can be any valid hex string
            config.sepolia.linkTokenAddress,
        ...
        await approveToken(config.sepolia.linkTokenAddress, feeWithBuffer);
